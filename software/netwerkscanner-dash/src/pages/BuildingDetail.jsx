    ...
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="bg-white p-6 rounded-3xl border border-slate-200 h-fit">
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onAddFloor(building.id, fName, fImage); setFName(''); setFImage(null); }}>
            ...
            <button type="submit" className="w-full bg-blue-600 text-white p-4 rounded-xl font-bold text-xs uppercase">Opslaan</button>
          </form>
        </div>
