...
- **dev**: een table die je alleen kan opvragen met data dat niet wordt verandert, wordt gebruikt mocht een table corrupt zijn zodat dat we nog waardes kunnen opvragen.
- De fingerprinting file vergelijkt nieuwe scans met manual‑scans en vult automatisch x,y in.
